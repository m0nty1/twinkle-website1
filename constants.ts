...
// --- CONFIGURATION ---
// Set to TRUE to generate AI visuals for the Preview environment.
// Set to FALSE for Production to force loading of real local images.
...
// These files must exist in /public/products/...
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  // =========================================
  {
    ...
    brand: 'Twinkle',
    images: [getPerfumeImg(0)], // perfume-001.jpg
